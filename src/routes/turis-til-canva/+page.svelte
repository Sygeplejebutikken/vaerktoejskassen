<script>
  ...
  <div class="bg-red-100 text-gray-800">
      ...
      <div class="bg-white p-6 rounded-lg shadow-lg max-w-md mx-auto">
        <div class="mb-4">
          ...
          <div class="relative">
            ...
            <button type="button" class="bg-gray-200 text-gray-700 py-2 px-4 rounded-lg font-semibold hover:bg-gray-300" on:click={() => document.getElementById('csvFileInput').click()}>
              Vælg fil
            </button>
